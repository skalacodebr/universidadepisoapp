...
export function Header({ totalSimulacoes, totalFechadas }: HeaderProps) {
  return (
    <>
      ...
      {/* Resumo de informações no cabeçalho */}
        ...
        <Card>
          <CardContent className="pt-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold">{totalSimulacoes}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-base font-medium">Hoje, 09:42</p>
              <p className="text-sm text-gray-500">Condomínio Parque das Árvores</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold">{totalFechadas}</p>
            </div>
          </CardContent>
        </Card>
      </div>
